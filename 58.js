/*
58同城
从这个入口：http://mtw.so/5UX5Y8
好像有新人15元奖励，玩过的也可以试试好像也送你15元奖励 干就完了。

IOS随便捉=[羊毛群:702490720]
多账号切换账号不能退出登录，只能清除数据，不懂清除就卸载重新安装
...
class UserInfo {
    constructor(str) {
        ...
        console.log(`账号[${this.index}]羊毛群提现您:702490720现在小游戏矿石设置为：${taskStr}`)
    }
