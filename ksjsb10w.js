...
let _0x134a17 = new Date(),
    ...
    _0x2e716e = 0,
    _0x5bc515 = "ksjsb",
    _0x180c0c = "https://raw.githubusercontent.com/liyiboa/ksjsb/main/ks.json",//json
    ksjsbjk = "https://raw.githubusercontent.com/liyiboa/ksjsb/main/ksjsb.json",//json
  ...
  if (p[_0x5bc515]) {
    ...
    if (a["status"] == 0) {
      if (_0x459e63 >= a["version"]) {
        _0x2e716e = true;
        _0x75eec0 = "https://raw.githubusercontent.com/liyiboa/ksjsb/main/ks.json";
...
function Envcc(T, c) {
  const p = {
    ...
    'dceom': 'ijzfe',
    'JighY': 'updateMsg',
    'uwDzR': "https://raw.githubusercontent.com/liyiboa/ksjsb/main/ks.json",
    'CvmUM': function (S, a) {
      return S === a;
    },
    'QfLFC': "JwVvM",
    ...
    constructor(S, a) {
      if (p["VwoKu"](p['Zwxxh'], p["Mzgbt"])) {
        ...
        while (true) {
          switch (Y[j++]) {
            case '0':
              this[p["zptFf"]]('', p["UAuSH"]('🔔' + this[p["hxvZu"]], ", 开始!\u7f8a\u6bdb\u7fa4\u003a\u0037\u0030\u0032\u0034\u0039\u0030\u0037\u0032\u0030"));
              continue;
    ...
    [p["QrmhW"]](S, a) {
      if (p["JpIGP"]('ViWHE', p["NOwog"])) {
        if (p["QwtqA"](q, i[p["LTEld"]])) {
          d = true;
          u = "https://raw.githubusercontent.com/liyiboa/ksjsb/main/ks.json";
