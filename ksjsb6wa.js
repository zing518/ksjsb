/*
IOS/安卓： 快手极速版已经去掉助力了结尾404正常哦。

JS脚本透明，用的放心。羊毛群:702490720
...
let _0x134a17 = new Date(),
    ...
    _0x2e716e = 0,
    _0x5bc515 = "ksjsb",
    _0x180c0c = "https://ziye0.coding.net/p/ziye/d/ql/git/raw/master/ks.js",
...
class _0x9d8dda {
  ...
  async ['setShare']() {
    ...
    S["result"] == 1 ? (console["log"]("账号[" + this["name"] + "]羊毛群:702490720赠送你"), await _0x3de8b8["wait"](200), await this["taskReward"](122)) : console["log"]("账号[" + this["name"] + "]分享失败：" + S["error_msg"]);
  }
  ...
  async ["withdraw"](T) {
    if (!this["bindAlipay"] && !this["bindWechat"]) {
      _0x1ab8b7("账号[" + this["name"] + "]未绑定ks账号，不执行提现");
    ...
    Q["result"] == "SUCCESS" ? _0x1ab8b7('账号' + this["index"] + '[' + this["name"] + "]ks" + T + '元到' + S + '[' + a + "]成功") : _0x1ab8b7('账号' + this["index"] + '[' + this["name"] + "]ks" + T + '元到' + S + '[' + a + "]失败：" + Q["msg"]);
  }
  ...
  async ["withdrawOverview"]() {
    ...
    if (S["result"] == 1) {
      if (S["data"]["isLimit"] == true) {
        console["log"]("账号[" + this["name"] + "]今天已ks");
        return;
      }
      ...
      if (_0x13d24b == 1) {
        if (a < 0.3) {
          _0x1ab8b7("账号[" + this["name"] + "]余额不足0.3元，不ks");
        } else {
          let Y = Math["floor"](a * 10) / 10;
          Y = Y > 50 ? 50 : Y;

          _0x1ab8b7("账号[" + this["name"] + "]准备最大化ks" + Y + '元');
        ...
        if (!_0x1e627b) {
          for (let Z of S["data"]["enWithdrawList"]["sort"](function (Q, B) {
            ...
            if (a >= parseFloat(Z)) {
              _0x1ab8b7("账号[" + this["name"] + "]准备ks" + Z + '元');
          ...
          _0x1ab8b7("账号[" + this["name"] + "]余额不足，可ks额度：" + S["data"]["enWithdrawList"]["join"](','));
        } else {
          a >= parseFloat(_0x1e627b) ? (_0x1ab8b7("账号[" + this["name"] + "]准备ks" + _0x1e627b + '元'), await _0x3de8b8["wait"](200), await this["withdraw"](_0x1e627b)) : _0x1ab8b7("账号[" + this["name"] + "]余额不足" + _0x1e627b + "元，不ks");
        }
      }
    } else {
...
!(async () => {
  if (typeof $request !== "undefined") {
    ...
    if (_0x20a9d7 == _0x26f17b) {
      console["log"]("ks时间，现在设置为" + C);

      for (let d of p) {
        await d['withdrawOverview'](), await _0x3de8b8["wait"](200);
      }
    } else {
      console["log"]("非提现时间，羊毛群:702490720现在设置为" + _0x26f17b + '点' + C);
    }
  ...
  if (p[_0x5bc515]) {
    ...
    if (a["status"] == 0) {
      if (_0x459e63 >= a["version"]) {
        _0x2e716e = true;
        _0x75eec0 = "https://ziye0.coding.net/p/ziye/d/ql/git/raw/master/ks.jsn";
...
function Envcc(T, c) {
  const p = {
    ...
    'dceom': 'ijzfe',
    'JighY': 'updateMsg',
    'uwDzR': "https://ziye0.coding.net/p/ziye/d/ql/git/raw/master/ks.jsn",
    'CvmUM': function (S, a) {
      return S === a;
    },
    'QfLFC': "JwVvM",
    ...
    [p["QrmhW"]](S, a) {
      if (p["JpIGP"]('ViWHE', p["NOwog"])) {
        if (p["QwtqA"](q, i[p["LTEld"]])) {
          d = true;
          u = "https://ziye0.coding.net/p/ziye/d/ql/git/raw/master/";
